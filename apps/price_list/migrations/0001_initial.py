    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_uuid', models.CharField(default=uuid.uuid4, help_text=b'What is the item specific UUID for this price list item? Must be unique per price list.', max_length=36)),
                ('name', models.CharField(help_text=b'What is the name of this price list item?', max_length=60)),
                ('description', models.TextField(help_text=b'What is the description of this price list item?')),
                ...
                ('unit_measurement', models.CharField(help_text=b"What is the unit measurement for this activity? (Example: 'hour' or 'kb')", max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment', models.ManyToManyField(help_text=b'Which pieces of equipment does this price list item associate with? (May be empty)', to='equipment.Equipment', null=True, blank=True)),
                ('price_list', models.ForeignKey(related_name='timepricelistitem_price_list', to='price_list.PriceList', help_text=b'Which price list does this price list item apply to?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_name', models.CharField(default=b'Unit', help_text=b"What is the unit name for this price list item? (Example: 'Rig')", max_length=20)),
                ('equipment', models.ManyToManyField(help_text=b'Which pieces of equipment does this price list item associate with? (May be empty)', to='equipment.Equipment', null=True, blank=True)),
                ('price_list', models.ForeignKey(related_name='unitpricelistitem_price_list', to='price_list.PriceList', help_text=b'Which price list does this price list item apply to?')),
                ('services', models.ManyToManyField(help_text=b'Which services does this price list item associate with? (May be empty)', to='equipment.Service', null=True, blank=True)),
                ('terms_of_service', models.ForeignKey(help_text=b'Which terms of service must a user agree to before using purchasing this price list item?', to='terms_of_service.TermsOfService')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='price_list',
            field=models.ForeignKey(related_name='activitypricelistitem_price_list', to='price_list.PriceList', help_text=b'Which price list does this price list item apply to?'),
